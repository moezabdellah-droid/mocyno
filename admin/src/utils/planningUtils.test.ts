...
const createEvent = (start: string, end: string, isSunday = false): PlanningEvent => ({
    id: 'evt-1',
    title: 'Mission',
...
it('should calculate standard hours correctly', () => {
    ...
    // @ts-expect-error - Mocking minimal agent for test
...
it('should calculate sunday hours', () => {
    ...
    const events = [
        createEvent(`${sunday}T08:00:00`, `${sunday}T18:00:00`, true) // 10h on Sunday
    ];
